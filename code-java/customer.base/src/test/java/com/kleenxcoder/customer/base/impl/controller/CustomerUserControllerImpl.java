...
public class CustomerUserControllerImpl<T extends CustomerUser, R extends CustomerUserRepository<T> , UG extends CustomerUserGenerator<T>, S extends CustomerUserService<T, R, UG> > extends CustomerBaseUserControllerImpl<T,R,S> implements CustomerUserController<T> {
